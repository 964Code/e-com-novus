...
// Tells express that when we use routes, we use /api/products as the base route and then depending on the request, if it is a get, post, put, delete, it will match the route and execute the callback function.
